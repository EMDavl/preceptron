...
public class SecondRunner {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < 5; i++) {
            System.out.printf("KEY: %d%n",i);

            List<KeyValuePair<Integer, Double[]>> valueList = prepareValues(i);
    ...
    private static List<KeyValuePair<Integer, Double[]>> prepareValues(int mainKey) throws IOException {
